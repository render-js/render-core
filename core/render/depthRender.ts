...
//渲染自定义标签
export function depthRender(proto: Component, parent: ParentNode, child:Element, tagLib:Map<string, Component>,link:Controller | ApiController):void{
    //生成DOM
...
//继续渲染
export function depthFindComponent(collection:HTMLCollection,tagLib:Map<string, Component>,link:Controller | ApiController):void
{
